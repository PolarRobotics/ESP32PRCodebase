...
#define turnMin 0.2
#else
#define turnMax 0.8 // the max allowable turning when the bot is traveling at lowest speed
#define turnMin 0.8 // the min allowable turning when the bot is traveling at full speed
#endif
